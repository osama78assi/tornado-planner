...
- the sidebar isn't getting closed when the user click outside
...
- the application is missing a whie theme
- the application is missing multi language (use i18next)
- the tasks must be lazy loaded
- the tasks must be editable via double click on the task
