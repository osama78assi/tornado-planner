...
function Modal({ isOpen, title, handleClose, className, children }) {
    ...
    return createPortal(
        <>
            ...
            <div
                ref={modalRef}
                className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex max-h-[90dvh] overflow-auto transition-opacity opacity-0 p-3 z-[900]"
            >
                {/* Modal panel */}
                {/**/}
                <div
                ...
                >
                    ...
                    {/* Children */}
                    <div className="p-3 w-full z-[11]">{children}</div>
                </div>
            </div>
        </>,
